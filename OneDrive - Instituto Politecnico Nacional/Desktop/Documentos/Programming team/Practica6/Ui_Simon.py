...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar.setGeometry(QtCore.QRect(380, 20, 118, 23))
...
"border-radius: 15px;")
        ...
        self.Regresarbtn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.Regresarbtn.setGeometry(QtCore.QRect(50, 10, 75, 24))
        self.Regresarbtn.setStyleSheet("background-color: rgb(255, 85, 0);\n"
"color:rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Regresarbtn.setText(_translate("MainWindow", "Regresar"))
